...
_DECELERATOR_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='instruction.Decelerator.State',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BOTTOM_AND_TWO_GEARING', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIG_GEARING', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SMALL_GEARING', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BOTTOM_AND_BIG_GEARING', index=8, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_DECELERATOR_STATE)
...
_DECELERATOR = _descriptor.Descriptor(
  name='Decelerator',
  full_name='instruction.Decelerator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='instruction.Decelerator.state', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='holo_x', full_name='instruction.Decelerator.holo_x', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='holo_y', full_name='instruction.Decelerator.holo_y', index=2,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='holo_depth', full_name='instruction.Decelerator.holo_depth', index=3,
      number=4, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ENGINEFIELDS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='decelerator', full_name='instruction.EngineFields.decelerator', index=4,
...
_DECELERATOR.fields_by_name['state'].enum_type = _DECELERATOR_STATE
_DECELERATOR_STATE.containing_type = _DECELERATOR
...
_ENGINEFIELDS.fields_by_name['decelerator'].message_type = _DECELERATOR
...
_ENGINEFIELDS.oneofs_by_name['state'].fields.append(
  _ENGINEFIELDS.fields_by_name['decelerator'])
_ENGINEFIELDS.fields_by_name['decelerator'].containing_oneof = _ENGINEFIELDS.oneofs_by_name['state']
...
DESCRIPTOR.message_types_by_name['Decelerator'] = _DECELERATOR
...
Decelerator = _reflection.GeneratedProtocolMessageType('Decelerator', (_message.Message,), dict(
  DESCRIPTOR = _DECELERATOR,
  __module__ = 'instruction_pb2'
  # @@protoc_insertion_point(class_scope:instruction.Decelerator)
  ))
_sym_db.RegisterMessage(Decelerator)
